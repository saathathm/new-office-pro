        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                ...
                <?php if (isset($_SESSION['emp_type']) and $_SESSION['emp_type'] != 1) { ?>
                    <?php if ($count != 1) { ?>
                        <span class="login-blurb"><a href="../controller/attendance.php?emp_id=<?php echo $_SESSION['emp_id']; ?>&&action=login_approved">
                                <div id="buzzer">
                                    <div></div>
                                </div>
                            </a></span>
                    <?php } else { ?>
                        <span class="login-blurb"><a href="../controller/attendance.php?emp_id=<?php echo $_SESSION['emp_id']; ?>&&action=logout_approved">
                                <div id="buzzer" class="act">
                                    <div class="act"></div>
                                </div>
                            </a></span>
                    <?php } ?>
